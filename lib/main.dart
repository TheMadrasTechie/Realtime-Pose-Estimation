...
class PosePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (final pose in poses) {
      pose.landmarks.forEach((_, landmark) {
        canvas.drawCircle(
            Offset(size.width-(landmark.x * scaleX), landmark.y * scaleY), 1, paint);
      });
       ...
       void paintLine(
         ...
         canvas.drawLine(Offset(size.width-(joint1.x * scaleX), joint1.y * scaleY),
             Offset(size.width-(joint2.x * scaleX), joint2.y * scaleY), paintType);
       }
      //
      // //Draw arms
       paintLine(
     ...
     paintLine(PoseLandmarkType.leftHip, PoseLandmarkType.leftKnee, leftPaint);
       ...
       paintLine(
          ...
          // Draw Face
      paintLine(
          PoseLandmarkType.rightEyeInner, PoseLandmarkType.rightEye, paint);
       paintLine(
          PoseLandmarkType.rightEye, PoseLandmarkType.rightEyeOuter, paint);
    }
  }
